...
public class ShoppingCartController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ShoppingCartCompleteDto> findEntityById(@Parameter(description = "insert cart id", example = "1")@PathVariable String id){
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Map<String, String>> deletedById(@Parameter(description = "insert cart id", example = "1") @PathVariable String id, HttpServletResponse response){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ShoppingCartDto> updateEntity(@Parameter(description = "insert user id", example = "1") @PathVariable String id, @RequestBody ShoppingCartForm shoppingCartDto, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public ResponseEntity<ShoppingCartCompleteDto> deletedOrderById(@Parameter(description = "insert product id", example = "1") @PathVariable String id, @Parameter(description = "find item by id", example = "1") @PathVariable String idItem){
